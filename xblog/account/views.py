...
def user_login(request):
    ...
    if request.method == "POST":
        ...
        if login_form.is_valid():
            ...
            if user:
                login(request, user)
                return HttpResponse("welcom to my blog")
            else:
                return HttpResponse("sorry, you username or password is not avliable")
        else:
...
def myself_edit(request):
    ...
    if request.method == "POST":
        ...
        if user_form.is_valid()*userprofile_form.is_valid()*userinfo_form.is_valid():
            ...
            userprofile.save()
            userinfo.save()
            return HttpResponseRedirect('/account/my_infomation/')
        else:
